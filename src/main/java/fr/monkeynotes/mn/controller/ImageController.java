...
public class ImageController {
    ...
    public ResponseEntity<Resource> getImageWithMediaType(@PathVariable String username, @PathVariable String fileId, @PathVariable int imageNum) throws IOException {
        ...
        imageService.efficientStreamImage(username, fileId, imageNum, baos);
    ...
    @GetMapping(value = "/image/stream/{username}/{fileId}/{imageNum}")
    public ResponseEntity<StreamingResponseBody> streamImageWithMediaType(@PathVariable String username, @PathVariable String fileId, @PathVariable int imageNum) throws IOException {
